  ...
  return (
    <header className="h-16 bg-white border-b border-slate-200 flex items-center justify-between px-6 lg:px-8">
      ...
      <div className="flex items-center gap-4 flex-1 max-w-md">
        <div className="relative w-full">
          ...
          <input
            ...
            className="w-full pl-10 pr-4 py-2 bg-slate-100 border-0 rounded-lg text-sm placeholder:text-slate-400 focus:ring-2 focus:ring-[#7C3AED] focus:outline-none"
          />
        </div>
      </div>
      ...
      <div className="flex items-center gap-3">
        <Button size="sm" className="bg-[#7C3AED] hover:bg-[#6D28D9]" onClick={() => router.push("/dashboard/customers")}>
          <Plus className="w-4 h-4 mr-1" />
          Request Review
        </Button>
        <div className="relative" ref={dropdownRef}>
          <button className="relative p-2 text-slate-500 hover:text-slate-700 hover:bg-slate-100 rounded-lg transition-colors" onClick={() => setShowDropdown(!showDropdown)} aria-label="Notifications">
